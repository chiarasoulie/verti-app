<template>
    <v-row
      ...
      <div class="diagnostic"style="text-align: center;font-family: Manjari; color: #20285F">
        ...
        <h2>MIGRAINE</h2>
        <div class="petit"></div>
        <h2>DEFICIT VESTIBULAIRE <br> BRUSQUE SEQUELLAIRE</h2>
      </div>
      <br>
      <br>
      ...
      <div style="display: inline-block; text-align: center;font-family: Manjari;"id=attention>
        <img src="../assets/triangle.png" alt="Image infos" style="width: 20px; height: auto; vertical-align: middle;margin-right: 10px;">
        <span style="display: inline-block; vertical-align: middle; color: #20285F;">Faire un examen neurologique</span> 
      </div>
      <br>
      <br>
      <br>
...
diag.value="FAUX VERTIGE/MIGRAINE/DEFICIT VESTIBULAIRE BRUSQUE SEQUELLAIRE";

</script>

<style scoped>
.diagnostic {
  background-color: #CFCFCF; /* couleur grise */
  width: 100%;
  padding: 20px 0; /* espace autour du titre */
  text-align: center;
...
.petit{
  background-color: #e8e2e2; /* couleur grise */
  width: 50%;
  height: 3px;
  margin: auto;
